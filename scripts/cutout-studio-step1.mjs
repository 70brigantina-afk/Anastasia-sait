...
const src = path.join(
  root,
  "public/images/anastasia/originals/portrait-walking-studio.png"
);
const outDir = path.join(root, "public/images/anastasia/originals");
const rawOut = path.join(outDir, "portrait-walking-studio-cutout-raw.png");

await mkdir(outDir, { recursive: true });
console.log("Removing background from studio photo...");
